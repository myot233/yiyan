...
public class RoadConditionUtil {

    public static String URL = "https://api.map.baidu.com/traffic/v1/road?";

    public static String AK = "6sjWjflCZmzWtbZzOQh9Yhw03DuADVjw";

    public static void main(String[] args) throws Exception {

        RoadConditionUtil snCal = new RoadConditionUtil();

        Map params = new LinkedHashMap<String, String>();
        params.put("road_name", "东二环");
        params.put("city", "北京市");
        params.put("ak", AK);
